...
import { KeyboardRef } from "../Keyboard/type";
import { InputRef } from "../Input/type";
...
const InputKeyboard = forwardRef<InputKeyboardRef, InputKeyboardProps>((props: InputKeyboardProps, ref) => {
  ...
  const { theme: keyboardTheme, styles: keyboardStyles, keyboardId, toolbarId, ...keyboardRest } = keyboardProps || {};
  const { onFocus, onBlur, theme: inputTheme, styles: inputStyles, ...inputRest } = inputProps || {};
